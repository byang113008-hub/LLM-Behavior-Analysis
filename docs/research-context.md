...
The literature reviewed above strongly overlaps with pieces of that question, but does not appear to package that exact user-level problem as its central object. 5
...
- and user trajectory in real interaction. 6
...
That is the research context in which these documents should be read. 7
